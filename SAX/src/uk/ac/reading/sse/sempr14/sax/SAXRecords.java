package uk.ac.reading.sse.sempr14.sax;
...
public class SAXRecords implements Iterable<SAXRecord> {
	 ...
	 */
	public ArrayList<HashMap.Entry<Integer, String>> getSAXString() {
		...
		ArrayList<HashMap.Entry<Integer, String>> words = new ArrayList<HashMap.Entry<Integer, String>>();
		for (int i : index)
			words.add(new HashMap.SimpleEntry<Integer, String>(i, String.valueOf(this.realTSindex.get(i).getPayload())));
		return words;
	}
